...
<section class="content">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="box box-primary card" style="padding:5%;padding-bottom: 10%;">
                <div class="box-body">
                    ...
                    <form action="<?php echo url('/pireps/mine');?>" method="post">
                        <div class="form-group">
                            <label>Pilot</label>
                            <input type="text" class="form-control" disabled value="<?php echo Auth::$userinfo->firstname . ' ' . Auth::$userinfo->lastname;?>">
                        </div>
                        <div class="form-group">
                            <label>Airline</label>
                        ...
                        <div class="form-group">
                            ...
                            <p>Enter the fuel used on this flight in <?php echo Config::Get('LIQUID_UNIT_NAMES', Config::Get('LiquidUnit'))?></p>
                        </div>
                        <div class="form-group">
